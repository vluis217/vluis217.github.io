---
title: ¿Cómo conseguir su primer trabajo en ciberseguridad?
date: 2024-05-26
...
- _¿Si llevo X curso podré conseguir trabajo sin problemas?_
...
- _"No cumplo con todos los requisitos que piden, entonces no voy a aplicar"_
- _"Mi inglés es muy malo"_
- _"Primero debo completar \[actividad arbitraria que me inventé solo\] antes de poder optar por el empleo que quiero"_
...
- En cuanto a la lista de habilidades, se pueden poner en una sección aparte, pero es mejor resaltar las diferentes competencias o tecnologías en el contexto en el cual se aprendieron o se pusieron en práctica. Por ejemplo, como lo tengo yo:
    ![CV](/assets/img/posts/como-conseguir-su-primer-trabajo-en-ciberseguridad/cv.png)
...
- Busque métodos para hacer buenas entrevistas, y practique. Uno recomendado es el Método STAR ([1](https://www.splunk.com/en_us/blog/splunklife/mastering-interviews-using-the-star-technique.html) [2](https://www.themuse.com/advice/star-interview-method) [3](https://resources.biginterview.com/behavioral-interviews/star-interview-method/)).
- Al final de cada entrevista, haga al menos las siguientes dos preguntas:
    - "_¿Si usted me contratara hoy, cuál sería la mejor manera en la que usted utilizaría mis habilidades en este momento?_". Es una pregunta de ingeniería social, que fuerza al entrevistador a pensar en usted como un empleado, y no como un simple candidato.
    - "_¿Tiene algún consejo o sugerencia de algo que pueda mejorar?_". Es difícil que le den feedback días después de la entrevista, y mucho más difícil que se lo den sin pedirlo, por eso es que pedir retroalimentación al final de cada entrevista es donde tiene más posibilidades que se la den.
...
-  Infosec Job Hunting playlist: [https://www.youtube.com/playlist?list=PLqz80p7f6dFumNG0wU4Ql41PvhzamHO3\_](https://www.youtube.com/playlist?list=PLqz80p7f6dFumNG0wU4Ql41PvhzamHO3_)
-  How to Job Hunt Like a Hacker - OSINT EDITION: [https://www.youtube.com/watch?v=bUvVaXZRnTA](https://www.youtube.com/watch?v=bUvVaXZRnTA)
- Canal de YouTube ITCareerQuestions: [https://www.youtube.com/@Itcareerquestions](https://www.youtube.com/@Itcareerquestions)
- Consejos y notas de una ingeniera de ciberseguridad de Google: [https://github.com/gracenolan/Notes](https://github.com/gracenolan/Notes)
- Simulaciones de empleo, para tener una idea de cómo es el día a día en un trabajo real en ciberseguridad: [https://www.theforage.com/simulations?careers=security](https://www.theforage.com/simulations?careers=security)
- “How To Get Your First Job In Cybersecurity“ escrito por Tanya Janca: [https://shehackspurple.ca/2025/11/21/how-to-get-your-first-job-in-cybersecurity/](https://shehackspurple.ca/2025/11/21/how-to-get-your-first-job-in-cybersecurity/)

### Aprendizaje a base de proyectos
- [https://github.com/AlgoryL/Projects-from-Scratch](https://github.com/AlgoryL/Projects-from-Scratch)
- [https://github.com/cweagans/awesome-diy-software](https://github.com/cweagans/awesome-diy-software)
...
- [https://medium.com/coderbyte/learn-by-doing-the-8-best-interactive-coding-websites-4c902915287c](https://medium.com/coderbyte/learn-by-doing-the-8-best-interactive-coding-websites-4c902915287c)
- [https://projectlearn.io/](https://projectlearn.io/)

### Proyectos específicos de ciberseguridad
- Intrusion detection: [https://www.youtube.com/watch?v=7c8xowHz0Ko](https://www.youtube.com/watch?v=7c8xowHz0Ko)
- Phishing simulation: [https://alphasec.io/phishing-attack-simulation-with-gophish/](https://alphasec.io/phishing-attack-simulation-with-gophish/)
- SOC home lab: [https://www.youtube.com/watch?v=2XLzMb9oZBI](https://www.youtube.com/watch?v=2XLzMb9oZBI)
- Vulnerability management: [https://github.com/0xrajneesh/Vulnerability-Management-Projects-for-Beginners](https://github.com/0xrajneesh/Vulnerability-Management-Projects-for-Beginners)
...
Si tienen alguna duda, comentario, o simplemente quieren conectar conmigo, lo pueden hacer en mis redes sociales [linktr.ee/vluis217](https://linktr.ee/vluis217).
