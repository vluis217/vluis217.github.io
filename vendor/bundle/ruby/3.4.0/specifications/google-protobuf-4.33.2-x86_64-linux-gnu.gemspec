# -*- encoding: utf-8 -*-
# stub: google-protobuf 4.33.2 x86_64-linux-gnu lib

Gem::Specification.new do |s|
  s.name = "google-protobuf".freeze
  s.version = "4.33.2".freeze
  ...
  s.metadata = { "source_code_uri" => "https://github.com/protocolbuffers/protobuf/tree/v4.33.2/ruby" } if s.respond_to? :metadata=
