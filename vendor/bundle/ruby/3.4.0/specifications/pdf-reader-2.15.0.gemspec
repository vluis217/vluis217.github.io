# -*- encoding: utf-8 -*-
# stub: pdf-reader 2.15.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/yob/pdf-reader/issues", "changelog_uri" => "https://github.com/yob/pdf-reader/blob/v2.15.0/CHANGELOG", "documentation_uri" => "https://www.rubydoc.info/gems/pdf-reader/2.15.0", "source_code_uri" => "https://github.com/yob/pdf-reader/tree/v2.15.0" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<afm>.freeze, [">= 0.2.1".freeze, "< 2".freeze])
end
